...
//
//        let iconArr:NSArray  = ["chatcamer","chatrecord","chatpen","chatGIF","chatvoice","chatpinged","chatfile","chatlocation"]
//
       
        var count=0;
        buttons.forEach {
            
//            let iconName=iconArr.object(at:count)
//            expandRowButton.setImage(UIImage.init(named: iconName as! String), for: .normal)
//            $0.setBackgroundImage(UIImage.init(named: "chatPing"), for: .normal)
...
//        expandRowButton.setIcon(.ellipsis, with: .tiny, for: UIControlState())
        ...
        expandRowButton.setImage(UIImage.init(named: "chatPage"), for: .normal)
