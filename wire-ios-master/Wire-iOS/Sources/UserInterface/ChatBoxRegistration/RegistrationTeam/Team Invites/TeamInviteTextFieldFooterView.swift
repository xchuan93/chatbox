...
final class TeamInviteTextFieldFooterView: UIView {
    ...
    @objc private func showLearnMorePage() {
        let url = URL(string: "https://support.chatbox.tech/hc/en-us/articles/115004082129-My-email-address-is-already-in-use-and-I-cannot-create-an-account-What-can-I-do-")!
