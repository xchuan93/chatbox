...
//        [MBProgressHUD showHUD];
    ...
    if (type==1) {
        sessionTask = [manager GET:urlStr parameters:params success:^(NSURLSessionDataTask * _Nonnull task, id  _Nonnull responseObject) {
...
//        }];
        ...
        sessionTask = [manager POST:url parameters:params success:^(NSURLSessionDataTask * _Nonnull task, id  _Nonnull responseObject) {
...
+(NSString *)strUTF8Encoding:(NSString *)str{
    ...
    return encodedUrl;
//    return [str stringByAddingPercentEncodingWithAllowedCharacters:<#(nonnull NSCharacterSet *)#>];
}
@end
