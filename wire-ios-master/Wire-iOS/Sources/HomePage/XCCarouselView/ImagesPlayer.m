...
- (UIPageControl *)indicatorView
{
    if (!_indicatorView) {
        ...
        page.currentPageIndicatorTintColor = [UIColor colorWithRGB:192 g:160 b:98 alpha:1];
...
- (void)layoutSubviews
{
    ...
    self.indicatorView.frame  = CGRectMake(W * 0.5, H - 32.0, 0, 0);
}

- (void)addmaskView{
    UIView *maskView = [UIView new];
    maskView.backgroundColor = [UIColor colorWithRGB:0 g:0 b:0 alpha:0.5];
